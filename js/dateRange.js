...
*/
				...
				'<div class="ta_calendar_footer cf" '+ (this.mOpts.autoSubmit ? ' style="display:none" ' : '') +'>',
					'<div class="frm_msg">',
						'<div id="' + this.dateRangeDiv + '">',
							'<input hidden="hidden"type="text" class="ta_ipt_text_s" name="' + this.startDateId + '" id="' + this.startDateId + '" value="' + this.mOpts.startDate + '" readonly />',
							'<span class="' + this.mOpts.joinLineId + '"> - </span>',
							'<input type="text"hidden="hidden" class="ta_ipt_text_s" name="' + this.endDateId + '" id="' + this.endDateId + '" value="' + this.mOpts.endDate + '" readonly /><br />',
						'</div>',
	...
	ta:[
		...
		'	<a class="opt_sel" id="'+ this.mOpts.compareTrigger +'" >',
        '		<i class="i_orderd"></i>',
        '	</a>',
		'</div>'
	]
...
pickerDateRange.prototype.close = function(btnSubmit) {
    ...
    //$('#' + this.inputId).val($('#' + this.startDateId).val() + ($('#' + this.startDateId).val() == $('#' + this.endDateId).val() ? '' : this.mOpts.defaultText + $('#' + this.endDateId).val()));
		...
		document.getElementById("start").innerText=$('#' + this.startDateId).val();
	document.getElementById("end").innerText=$('#' + this.endDateId).val();
